  ...
  <body>
        ...
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                // $query = "select * from employees limit 20 ,20";
             ...
             // $query = "select * from customers  WHERE state =   '". $state . "'";
            ...
            echo '<h2>Method 2 -stop / start PHP - use HTML template</h2>';
                ...
                while  ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                    ...
                    <!-- this will be the GET method -->
                         ...
                         <td><a href="get_one_record.php?id=<?php echo $row['customerNumber'];?>"> <?php echo htmlentities($row['contactFirstName']);?></a></td>
